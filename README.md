...
| Swap | ![Swap](https://gamepedia.cursecdn.com/riskofrain2_gamepedia_en/thumb/8/8d/Retool.png/128px-Retool.png?version=53426b923f0280f1016f58327be358df) | `+25%` faster switching and gain `+1 second` of bonus attack speed per level |
...
| Pressure Mines | ![Pressure Mines](https://gamepedia.cursecdn.com/riskofrain2_gamepedia_en/9/9e/Pressure_Mines.png?version=bc1cc946c19e73379eba73b8b181da08) | `+25%` damage, `+25%` blast radius, and `+25%` trigger radius per level |
...
| Charged Nano-Bomb | ![Charged nano-bomb](https://gamepedia.cursecdn.com/riskofrain2_gamepedia_en/thumb/c/c8/Charged_Nano-Bomb.png/128px-Charged_Nano-Bomb.png?version=749364707a1c24b755823a2510dbbd7c) | `+25%` damage and `+50%` max charge time per level |
| Charged Nano-Spear | ![Charged nano-spear](https://gamepedia.cursecdn.com/riskofrain2_gamepedia_en/9/92/Cast_Nano-Spear.png?version=de2ff32f16c4237e2346bfda2e15de5e) | `+25%` damage and `+50%` max charge time per level |
| Snapfreeze | ![Snapfreeze](https://gamepedia.cursecdn.com/riskofrain2_gamepedia_en/c/ce/Snapfreeze.png?version=6f15a989c9b98a8ad36f39a3ccd0b514) | `+50%` wall damage and `+25%` wall length per level |
