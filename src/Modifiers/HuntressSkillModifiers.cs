...
namespace Skills.Modifiers {
    ...
    class HuntressGlaiveSkillModifier : BaseSkillModifier<ThrowGlaive> {
        ...
        public override void OnSkillLeveledUp(int level) {
            Logger.DebugFormat("Glaive stats - max bounces: {0}, damage coefficient: {1}", ThrowGlaive.maxBounceCount, ThrowGlaive.damageCoefficientPerBounce);
    ...
    class HuntressArrowRainSkillModifier : BaseSkillModifier<ArrowRain> {
        ...
        public override void OnSkillLeveledUp(int level) {
            ...
            Logger.DebugFormat("ArrowRain stats - arrowRainRadius: {0}, damageCoefficient: {1}, prefabScale {2}", ArrowRain.arrowRainRadius, ArrowRain.damageCoefficient, ArrowRain.projectilePrefab.transform.localScale);
        }
